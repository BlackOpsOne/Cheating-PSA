# Important Notes
This files contains bits of information that are relevant to the topic.
...
> [!CAUTION]
> Showing what you have in the folders that these reside in does not do anything, you can swap them out after showing what is there, especially with the rise of programs that place patches in folders such as [this one](./t5/Stealth-Cheating.md#patch-insertion-programs).
